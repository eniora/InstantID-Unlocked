...
- (EXPERIMENTAL) You can use "instant-id-gradio-unlocked_img2img.py" for pure img2img generation mode. I modified "instant-id-gradio-unlocked-16GB-VRAM.py" to use the already existing "pipeline_stable_diffusion_xl_instantid_img2img.py" file.
