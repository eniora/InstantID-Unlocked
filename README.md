...
- You can use "instant-id-gradio-unlocked_img2img.py" for pure img2img generation, I made the file using the already existing pipeline_stable_diffusion_xl_instantid_img2img.py file.
