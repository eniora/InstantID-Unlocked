...
- Visual prompt image. You input an image and the generation will follow that image's style and colors etc. Also added the ability to set per-ID visual style for Multi-ID (for the first two IDs).
