...
- New default ProtoVision XL 6.6 model, which is much better than the default YamerMIX (you can still download the base model of your choice by changing the huggingface model path inside instant-id-gradio-unlocked.py file and it will be downloaded automatically in the "models" folder on root). /John6666/albedobase-xl-v31large-sdxl/, SG161222/RealVisXL_V4.0, and John6666/cyberrealistic-xl-v58-sdxl are very good models for styles and general use as well.
